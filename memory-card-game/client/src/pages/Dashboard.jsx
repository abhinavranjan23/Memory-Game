  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsResponse, matchesResponse] = await Promise.all([
        handleApiCall(() => axios.get('/game/stats/user'), null, 'Failed to load user stats'),
        handleApiCall(() => axios.get('/game/history/matches?limit=5'), null, 'Failed to load recent matches')
      ]);

      setStats(statsResponse.data.statistics);
      setRecentMatches(matchesResponse.data.matches);
      
      // Mock achievements for now (would come from backend)
      setAchievements([
        { id: 'first_win', name: 'First Victory', description: 'Won your first game', iconUrl: '🥇', unlocked: true },
        { id: 'perfect_memory', name: 'Perfect Memory', description: 'Complete a game without any wrong matches', iconUrl: '🧠', unlocked: false },
        { id: 'speed_demon', name: 'Speed Demon', description: 'Win a Blitz mode game', iconUrl: '⚡', unlocked: true },
        { id: 'social_butterfly', name: 'Social Butterfly', description: 'Play with 10 different players', iconUrl: '🦋', unlocked: false }
      ]);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            ...
            <p className="text-blue-100 text-lg">
              Ready to challenge your memory? Let's see what you can achieve today!
            </p>
          </div>
        ...
        <div className="lg:col-span-2">
          ...
          >
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Recent Matches</h2>
                <button
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-100">
                  Try to create visual patterns or stories with the cards you remember. 
                  This technique can dramatically improve your memory performance!
                </p>
              </div>
            </div>
          </motion.div>
